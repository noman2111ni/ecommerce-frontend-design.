...
const Section2 = () => {
    ...
    const fetchProducts = async () => {
        try {
            let res = await fetch('https://fakestoreapi.com/products?limit=6')
    ...
    return (
        <div className="bg-white  flex flex-col lg:flex-row rounded-sm shadow-md mb-6 border border-gray-200 overflow-hidden ">
            {/* Banner Section */}
            <div className='bg-red-300 bg-[url("https://images.unsplash.com/photo-1689088662950-57b392efaf90?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTh8fHByb2R1Y3QlMjB3ZWJzaXRlfGVufDB8fDB8fHww")] bg-cover bg-center bg-blend-multiply w-full lg:w-[25%] min-h-[220px] lg:min-h-full p-6 flex flex-col '>
